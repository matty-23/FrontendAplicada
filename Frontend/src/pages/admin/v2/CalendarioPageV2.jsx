      ...
      <div className="v2-main">
        <header className="v2-topbar">
          <div className="v2-topbar-left">
            <span className="v2-topbar-bc">Principal / Calendario</span>
            <span className="v2-topbar-title">Calendario General</span>
          </div>
        ...
        <div className="v2-content" style={{display:"flex",flexDirection:"column"}}>
