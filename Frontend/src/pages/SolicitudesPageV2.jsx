...
export default function SolicitudesPageV2() {
  ...
  return (
    <DashboardLayout breadcrumb="Principal / Solicitudes" title="Solicitudes" rightActions={rightActions}>
      <div className="v2-sol-layout">
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <Card 
            title="Pendientes de revisión" 
            subtitle="4 solicitudes esperando acción"
            headActions={<span className="v2-badge b-pending">4 pendientes</span>}
          ...
          <Card 
            ...
            headActions={<span className="v2-badge b-active">3 aprobadas</span>}
            bodyStyle={{ paddingTop: 14 }}
          >
            <div className="v2-timeline">
              {ACEPTADAS.map((s, i) => (
        ...
        <Card bodyStyle={{ height: "fit-content" }}>
